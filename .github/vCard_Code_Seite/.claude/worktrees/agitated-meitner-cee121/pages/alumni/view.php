...
<div class="almv-container max-w-4xl mx-auto">
    <!-- Back Button -->
    <div class="almv-back mb-6">
        <?php if ($returnTo === 'members'): ?>
            <a href="../members/index.php" class="almv-back-link inline-flex items-center transition-colors font-medium">
                <i class="fas fa-arrow-left mr-2"></i>
                Zurück zum Mitgliederverzeichnis
            </a>
        <?php else: ?>
            <a href="index.php" class="almv-back-link inline-flex items-center transition-colors font-medium">
                <i class="fas fa-arrow-left mr-2"></i>
    ...
    <!-- Profile Header Card -->
    <div class="almv-header card mb-6">
        <div class="almv-header-content flex flex-col md:flex-row gap-6">
            <!-- Profile Image -->
            <div class="almv-avatar-container flex justify-center md:justify-start flex-shrink-0">
                <?php
                ...
                ?>
                <div class="almv-avatar w-32 h-32 rounded-full flex items-center justify-center text-white text-4xl font-bold overflow-hidden shadow-lg">
                    <?php if ($hasActualImage): ?>
                        <img
                            ...
                            class="almv-avatar-img w-full h-full object-cover"
            ...
            <!-- Profile Info -->
            <div class="almv-info flex-1 min-w-0">
                <h1 class="almv-name text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                    <?php echo htmlspecialchars($profile['first_name'] . ' ' . $profile['last_name'], ENT_QUOTES, 'UTF-8'); ?>
                </h1>

                <!-- Role Badge -->
                <div class="almv-role mb-3">
                    <span class="almv-role-badge inline-flex items-center gap-1.5 px-4 py-1.5 text-sm font-semibold rounded-full border">
        ...
        <div class="almv-progress mt-6 p-4 rounded-xl">
            <div class="almv-progress-header flex items-center justify-between mb-1.5">
                <span class="almv-progress-label text-xs font-semibold">Profil-Fortschritt</span>
                <span class="almv-progress-percent text-xs font-bold"><?php echo $profileCompletenessPercent; ?>%</span>
            </div>
            <div class="almv-progress-bar w-full rounded-full h-2.5 overflow-hidden">
                <div class="almv-progress-fill h-2.5 rounded-full transition-all duration-500" style="width: <?php echo $profileCompletenessPercent; ?>%"></div>
            </div>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div class="almv-card card mb-6">
        <h2 class="almv-card-title text-lg font-bold mb-3 flex items-center gap-2">
            <span class="almv-card-icon inline-flex items-center justify-center w-8 h-8 rounded-full">
                <i class="fas fa-quote-left text-sm"></i>
            </span>
            Über mich
        </h2>
        <p class="almv-about leading-relaxed whitespace-pre-line break-words hyphens-auto"><?php echo htmlspecialchars($profileUser['about_me'], ENT_QUOTES, 'UTF-8'); ?></p>
    </div>
    <?php endif; ?>

    <div class="almv-grid grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-6 mb-6">
        <!-- Kontaktinformationen -->
        <div class="almv-card card">
            <h2 class="almv-card-title text-lg font-bold mb-4 flex items-center gap-2">
                <span class="almv-card-icon inline-flex items-center justify-center w-8 h-8 rounded-full">
    ...
    <div class="almv-card card mb-6">
        ...
        <div class="almv-skills-list flex flex-wrap gap-2">
            <?php foreach ($skillsList as $skill): ?>
            <span class="almv-skill-badge inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border">
    ...
    <div class="almv-card card mb-6">
        ...
        <a href="<?php echo htmlspecialchars(asset($profile['cv_path']), ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener noreferrer"
           class="almv-cv-btn inline-flex items-center gap-2 px-4 py-2 rounded-lg border transition font-medium text-sm">
...
<style>
/* ALMV (Alumni View) scoped styles */
.almv-container {
...
.almv-avatar {
    background: linear-gradient(135deg, var(--ibc-blue), #9333ea);
    flex-shrink: 0;
    width: 8rem;
    height: 8rem;
}
