...
.idea-modal-overlay.open .idea-modal-card { transform: none; opacity: 1; }

/* Mobile: bottom sheet */
@media (max-width: 599px) {
    .idea-modal-overlay { align-items: flex-end; padding: 0; }
    .idea-modal-card {
        border-radius: 1.5rem 1.5rem 0 0;
        box-shadow:
            0 0 0 1px rgba(0,0,0,.07),
    ...
    .idea-modal-card::before { border-radius: 1.5rem 1.5rem 0 0; }
...
.idea-modal-head-title {
    ...
    color: var(--text-main) !important; margin: 0; line-height: 1.25; letter-spacing: -.01em;
}
.idea-modal-head-sub {
    font-size: .78rem; color: var(--text-muted) !important; margin: .1rem 0 0;
}
...
.idea-modal-close-btn:hover { background: rgba(239,68,68,.08); border-color: rgba(239,68,68,.4); color: #ef4444; }
...
.idea-form-input::placeholder { color: var(--text-muted); opacity: .6; }
.idea-form-input:focus { border-color: #f59e0b; box-shadow: 0 0 0 3px rgba(245,158,11,.14); }
.idea-form-input:hover:not(:focus) { border-color: var(--text-muted); }

/* Char counter */
.idea-char-count { font-size: .73rem; color: var(--text-muted); }
...
.idea-modal-cancel-btn:hover { background: var(--bg-card); border-color: var(--text-muted); }
...
/* Dark mode — only overrides that CSS vars can't handle */
.dark-mode .idea-modal-card {
    box-shadow: 0 0 0 1px rgba(255,255,255,.07), 0 24px 64px rgba(0,0,0,.65);
}
.dark-mode .idea-form-input {
    background: rgba(255,255,255,.07);
    border-color: rgba(255,255,255,.11);
    color: var(--text-main);
    box-shadow: none;
}
.dark-mode .idea-form-input:focus {
    background: rgba(255,255,255,.10);
    border-color: #f59e0b;
    box-shadow: 0 0 0 3px rgba(245,158,11,.22);
}
.dark-mode .idea-form-input:hover:not(:focus) { border-color: rgba(255,255,255,.2); }
.dark-mode .idea-form-input::placeholder { color: rgba(255,255,255,.3); opacity: 1; }
.dark-mode .idea-modal-cancel-btn { background: rgba(255,255,255,.05); border-color: rgba(255,255,255,.11); }
.dark-mode .idea-modal-cancel-btn:hover { background: rgba(255,255,255,.09); border-color: rgba(255,255,255,.2); }
