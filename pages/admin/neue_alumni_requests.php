...
<div class="mb-8 relative overflow-hidden rounded-2xl shadow-lg">
    <div class="absolute inset-0 bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 opacity-95"></div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-white opacity-90">Verwaltung der eingehenden Neue-Alumni-Registrierungsanfragen</p>
                </div>
            </div>
