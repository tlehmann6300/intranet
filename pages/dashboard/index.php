...
<div class="dash-wrap mb-6 md:mb-10">
    ...
    <div class="grid grid-cols-1 <?php echo $canAccessInvoices ? 'md:grid-cols-2 lg:grid-cols-3' : 'md:grid-cols-2'; ?> gap-2 sm:gap-4 md:gap-6">
...
<div class="dash-wrap mb-6 md:mb-10">
    ...
    ?>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-4 md:gap-6">
