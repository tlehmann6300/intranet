            ...
            <div class="max-w-md mx-auto">
                ...
                <form method="POST" class="space-y-4">
                    ...
                    <div class="flex flex-col md:flex-row gap-3">
                        <a href="profile.php" class="flex-1 text-center px-6 py-3 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2">
                            Abbrechen
                        </a>
...
<div class="card p-6 mt-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <button type="button" onclick="showSupportModal('2fa_reset')"
           class="flex items-center p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg hover:bg-yellow-100 dark:hover:bg-yellow-900/40 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2 text-left w-full">
        ...
        <button type="button" onclick="showSupportModal('bug')"
           class="flex items-center p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/40 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2 text-left w-full">
            ...
            <form id="support-modal-form" method="POST" action="<?php echo asset('api/submit_support.php'); ?>" class="space-y-4">
                ...
                <div class="flex gap-3 justify-end">
                    <button type="button" onclick="hideSupportModal()"
                            class="px-6 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2">
                        Abbrechen
                    </button>
